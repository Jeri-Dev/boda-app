 ...
 * organize the wedding (name, attendance, optional message; menu and allergies
 * were removed entirely). Shown where personal data is collected (the RSVP form)
 * and on the public info page. `contact` is the couple's channel for data rights.
 */
export function PrivacyNotice({ contact }: { contact: string | null }) {
  return (
    <p className="text-xs leading-relaxed text-[var(--color-muted-foreground)]">
      Tus datos (nombre, asistencia y, si lo dejas, un mensaje) se usan
